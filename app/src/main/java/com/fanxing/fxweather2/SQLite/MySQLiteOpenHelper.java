package com.fanxing.fxweather2.SQLite;
...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public MySQLiteOpenHelper(Context context) {
        ...
        // 必须通过super调用父类的构造函数
        super(context, "FXweather.db", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table city(id integer primary key autoincrement,city varchar(64),cid varchar(64))";
        db.execSQL(sql);
